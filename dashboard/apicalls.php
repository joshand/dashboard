...
?>
        ...
        <section class="content">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">API Calls<font size='-2'>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="#" data-toggle="modal" data-target="#configbox">Create New</a></font></h3>
	...
	$(document).ready(function() {
			...
			},
	          	{
					...
					return '<a href="apicall.php?id=' + full[0] + '">' + data + '</a>';
			...
			},
                        {
                                ...
                                "render": function ( data, type, full ) {
                                        // 'full' is the row's data object, and 'data' is this column's data
                                        return '<div class="btn-group open"><a class="btn btn-xs bg-navy" href="apicall.php?action=copy&id=' + full[0] + '"><i class="fa fa-copy fa-fw"></i></a></div>';
                                        //return data;
                                }
                        }
	    ...
	    $('#apicalls tbody').on('click', 'tr', function () {
