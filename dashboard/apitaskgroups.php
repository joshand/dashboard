...
?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">API Task Groups</li>
          </ol>
        </section>
        ...
        <section class="content">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">API Task Groups<font size='-2'>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="#" data-toggle="modal" data-target="#configbox">Add Task Group</a></font></h3>

                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="apitaskgroups" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        <th>ID</th>
                        <th>Description</th>
	...
	$(document).ready(function() {
	    var table = $('#apitaskgroups').DataTable( {
	        "processing": true,
	        "serverSide": true,
	        "ajax": "./sp_apitaskgroups.php",
	        "columnDefs": [
	          {
	        	 "targets": [ 0 ],
	        	 "visible": false
			  },
	          {
	        	 ...
	        	 "render": function ( data, type, full ) {
		           // 'full' is the row's data object, and 'data' is this column's data
         	  	   return '<a href="./apitaskgroup.php?id=' + full[0] + '">' + data + '</a>';
			     }
			  }
			]
	    } );
	    
	    $('#apitaskgroups tbody').on('click', 'tr', function () {
			var name = table.row( this ).data();
			//alert(name[0]);
			window.location.replace('./apitaskgroup.php?id=' + name[0]);
	    } );

                $("#savebutton1").click(function(){
                        var gd = $("#gen_desc").val();
                        var tb = "api_taskgroups";
                        //console.log( sn + "-" + te);
                        $.ajax({
                                datatype : "json",
                                type: 'POST',
