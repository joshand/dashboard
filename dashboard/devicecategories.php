...
?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Device Categories</li>
          </ol>
        </section>
        ...
        <section class="content">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Device Categories<font size='-2'>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="#" data-toggle="modal" data-target="#configbox">Create New</a></font></h3>

                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="devcats" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        <th>ID</th>
                        <th>Description</th>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">New Device Category</h4>
				</div>
				<form role="form">
					<div class="modal-body">
						<div class="form-group">
							<label>Device Category Description</label>
        ...
        <div class="modal fade" id="configbox2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog" role="document">
                        <div class="modal-content">
                                <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        <h4 class="modal-title" id="myModalLabel">Edit Device Category</h4>
                                </div>
                                <form role="form">
                                        <div class="modal-body">
	...
	$(document).ready(function() {
	    var table = $('#devcats').DataTable( {
	        "processing": true,
	        "serverSide": true,
	        "ajax": "./sp_devdetails.php?type=c",
	        "columnDefs": [
	          	{
	        	 	"targets": [ 0 ],
	        	 	"visible": false
            ...
            $('#devcats tbody').on('click', 'tr', function () {
