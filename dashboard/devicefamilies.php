...
?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Device Families</li>
          </ol>
        </section>
        ...
        <section class="content">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Device Families<font size='-2'>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="#" data-toggle="modal" data-target="#configbox">Create New</a></font></h3>

                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="devfams" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        <th>ID</th>
                        <th>Description</th>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">New Device Family</h4>
				</div>
				<form role="form">
					<div class="modal-body">
						<div class="form-group">
							<label>Device Family Description</label>
							<input type="text" class="form-control" placeholder="Description" name="gen_desc" id="gen_desc">
						</div>
                    				<div class="form-group">
                      					<label>Device Category</label>
                      					<select class="form-control" name="dev_cat" id="dev_cat">
                        				<?php
                        				...
                        				?>
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="dev_fun" id="dev_fun">
                                                        <?php
                                                                echo GetOptionDropdown($dbtype,$dbserver,$dbname,$dbun,$dbpw,"typefunction", "id", "LabelSingular", "");
                                                        ?>
                                                        </select>
                                                </div>
        ...
        <div class="modal fade" id="configbox2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog" role="document">
                        <div class="modal-content">
                                <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        <h4 class="modal-title" id="myModalLabel">Edit Device Family</h4>
                                </div>
                                <form role="form">
                                        <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                        <label>Basic Function</label>
                                                        <select class="form-control" name="edit_fun" id="edit_fun">
                                                        <?php
                                                                echo GetOptionDropdown($dbtype,$dbserver,$dbname,$dbun,$dbpw,"typefunction", "id", "LabelSingular", "");
                                                        ?>
                                                        </select>
	...
	$(document).ready(function() {
	    var table = $('#devfams').DataTable( {
	        "processing": true,
	        "serverSide": true,
	        "ajax": "./sp_devdetails.php?type=f",
	        "columnDefs": [
	          	{
	        	 	"targets": [ 0,4,5 ],
	        	 	"visible": false
            ...
            $('#devfams tbody').on('click', 'tr', function () {
                        ...
                        document.getElementById("edit_cat").value = name[4];
                        document.getElementById("edit_fun").value = name[5];
                        showTheModal();
            } );
		...
		$("#savebutton1").click(function(){
			var gd = $("#gen_desc").val();
			var tb = "typedevicefamily";
			var ext1 = $("#dev_cat").val();
			var ext2 = $("#dev_fun").val();
			//console.log( sn + "-" + te);
			$.ajax({
				datatype : "json",
				type: 'POST',
                ...
                $("#savebutton2").click(function(){
                        ...
                        var tb = "typedevicefamily";
                        var ext1 = $("#edit_cat").val();
                        var ext2 = $("#edit_fun").val();
                        //console.log( sn + "-" + te);
                        $.ajax({
                                datatype : "json",
                                type: 'POST',
